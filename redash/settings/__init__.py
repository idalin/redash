...
GENERIC_OAUTH_CLIENT_ID =os.environ.get("REDASH_GENERIC_OAUTH_CLIENT_ID","")
GENERIC_OAUTH_CLIENT_SECRET = os.environ.get("REDASH_GENERIC_OAUTH_CLIENT_SECRET","")
GENERIC_OAUTH_SCOPES = os.environ.get("REDASH_GENERIC_OAUTH_SCOPES","")
GENERIC_OAUTH_BASE_URL=os.environ.get("REDASH_GENERIC_OAUTH_BASE_URL","")
GENERIC_OAUTH_AUTH_URL = os.environ.get("REDASH_GENERIC_OAUTH_AUTH_URL","")
GENERIC_OAUTH_TOKEN_URL =os.environ.get("REDASH_GENERIC_OAUTH_TOKEN_URL","")
GENERIC_OAUTH_API_URL = os.environ.get("REDASH_GENERIC_OAUTH_API_URL","")
GENERIC_OAUTH_ALLOW_SIGNUP = os.environ.get("REDASH_GENERIC_OAUTH_ALLOW_SIGNUP","true")
GENERIC_OAUTH_ENABLE=bool(GENERIC_OAUTH_CLIENT_ID and GENERIC_OAUTH_CLIENT_SECRET)
